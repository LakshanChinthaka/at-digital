...
function About() {
    return (
        <div className='grid grid-rows-2 mx-auto justify-center mt-[40px] '>
            ...
            {/* Box 1 */}
            <div className='grid md:grid-cols-2  lg:w-[896px]  xl:w-[1064px] xl:h-[414px] mx-auto lg:h-[349px] md:w-[688px] md:h-[275px]  xl:gap-[108px] md:gap-[20px] h-[572.82px] w-[335px]'>
                <div>
            ...
            {/* Box 2 */}
            <div className=' mt-20 grid md:grid-cols-2  lg:w-[896px]  xl:w-[1064px] xl:h-[414px] mx-auto lg:h-[349px] md:w-[688px] md:h-[276px]  xl:gap-[108px] md:gap-[20px] h-[572.82px] w-[335px]'>
                ...
                <div className=' w-[335px] h-[277px] lg:w-[530px] lg:h-[187px] grid grid-rows-3 justify-center md:mt-[50px] xl:mt-[100px] mt-[50px] gap-[20px] md:w-[393px] md:h-[239px]'>

                    <h3 className='text-center md:text-left h-[66px] xl:w-[507px] xl:h-[33px] lg:w-[507px] lg:h-[33px]  mb-20 md:w-[393px] md:h-[66px] font-meduim text-[27px] leading-[33px] tracking-[0.4px] text-primary font-semibold gap-[12px] w-[335px]'>Digital Strategy Consulting</h3>

                    <p className='text-center text-pretty md:text-left font-normal leading-[19.36px] md:w-[393px] md:h-[95px] h-[76px] text-base mt-[-10px] w-[335px]'>Your digital strategy should complement the overall marketing strategy of the company. In online marketing, each component will never work in isolation and every business needs a different mix. We provide a clear concept and strategic overview to find the most efficient model for your business.</p>
                 
                    <div className='flex justify-center md:justify-start mt-[35px] md:mt-10  lg:mt-[50px]'>
                        <LearnMoreBtn />
