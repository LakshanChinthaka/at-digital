...
function About() {
    return (
        <div className='grid grid-rows-2 mx-auto justify-center mt-[40px] '>
            ...
            {/* Box 1 */}
            <div className='grid md:grid-cols-2  lg:w-[896px] sm:mt-10 md:mt-[150px] lg:mt-10  xl:w-[1064px] xl:h-[414px] mx-auto lg:h-[349px] md:w-[688px] md:h-[275px]  xl:gap-[108px] md:gap-[20px] h-[572.82px] w-[335px]'>
                <div>
